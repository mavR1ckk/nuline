...
const About = () => {
    ...
    return (
        <div style={{ background: "#F5F5F5" }}>
            ...
            <div>
                <h2 className="h1_1 align-center"> Who we are?</h2>
                <p className="align-center p1">Nuline® was founded in 2022 with the idea of providing India with sports nutrition supplements that are specifically focused on
                    <br />   Indian customer needs and listens to their sentiments day in day out..</p>
            </div>
            <h2 className="h1_1 align-center"> What we deliver?</h2>
            <div >
                <div className="home_content container" style={{backgroundColor:"#DCDCDC"}}>
                    ...
                    <div className="text_part col-8">
                        ...
                        <p>Driven by the desire to exceed your expectations, we have brought together
                            |<br /> pharmaceutical expertise and the best experts of the chocolate flavor to create a path-breaking formulation with unmatched taste.
                            <br />This gave birth to the "Best Tasting Chocolate Whey Protein Shake",
                            <br />which was confirmed by the consumers themselves in a blind taste study done by Nielsen in 2015.
                            <br />  The same research orientation was also the bedrock for the formulation of Biozyme Whey, which was craft
                            The same research orientation was also the bedrock for the formulation of Biozyme Whey,
                            <br />which was crafted over a 2-year period and clinically tested to provide 50% higher protein absorption.
                        </p>
                    </div>
                </div>
            </div>
